...
// properties
    ...
    const {writtenDateTime, writerNickname,writerProfileImage} = boardListItem;
        ...
        <div className='board-list-item-main-box'>
            <div className='board-list-item-top'>
                ...
                <div className='board-list-item-write-box'>
                    <div className='board-list-item-writter-nickname'>{writerNickname}</div>
                    <div className='board-list-item-written-date'>{writtenDateTime}</div>
                </div>
            </div>
            ...
            <div className='board-list-item-bottom'>
                <div className='board-list-item-counts'>
                    {`덧글 ${commentCount}   좋아요 ${favoriteCount}    조회수 ${viewCount}`}
                </div>
            </div>
        </div>
